...
const StoryPanel: React.FC<StoryPanelProps> = ({ notes, onNotesChange, isOpen, onToggle, wordCount, hasMessages, isExtracting }) => {
    ...
    return (
        <>
            ...
            <div className="fixed inset-y-0 right-0 z-40 md:relative flex w-full sm:w-80 md:w-72 lg:w-80 flex-col border-l border-ink-400/12 bg-ink md:bg-ink-50/30 shadow-2xl md:shadow-none animate-slide-left">
                {/* Header */}
